 ...
 */
-(void)closePeripheral:(nonnull CBPeripheral *_Nullable)peripheral;
 ...
 */
-(void)writeValue:(NSData *_Nullable)data forCharacteristic:(nonnull CBCharacteristic *_Nullable)characteristic type:(CBCharacteristicWriteType)type;
@end
